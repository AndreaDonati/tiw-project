...
public class AuthorizationChecker extends MyHttpServlet implements Filter{
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {		
		...
		//TODO: se questo parametro non � nella richiesta il server ritorna una pagina di errore, ok o non ok?
